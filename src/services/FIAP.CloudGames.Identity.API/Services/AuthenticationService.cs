...
namespace FIAP.CloudGames.Identity.API.Services
{
    public class AuthenticationService
    {
        ...
        public async Task<UserResponseLogin> GerarJwt(string email)
        {
            ...
            var encodedToken = await GenerateJwt(identityClaims);
        ...
        private async Task<string> GenerateJwt(ClaimsIdentity identityClaims)
        {
        ...
        private UserResponseLogin ObterRespostaToken(string encodedToken, IdentityUser user, IEnumerable<Claim> claims, RefreshToken refreshToken)
        {
